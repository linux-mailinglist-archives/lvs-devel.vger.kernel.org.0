...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4C0CF5B2931
	for <lists+lvs-devel@lfdr.de>; Fri,  9 Sep 2022 00:23:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229536AbiIHWWG (ORCPT <rfc822;lists+lvs-devel@lfdr.de>);
        Thu, 8 Sep 2022 18:22:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40364 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230115AbiIHWWC (ORCPT
        <rfc822;lvs-devel@vger.kernel.org>); Thu, 8 Sep 2022 18:22:02 -0400
Received: from mg.ssi.bg (mg.ssi.bg [193.238.174.37])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id F0561F340F
        for <lvs-devel@vger.kernel.org>; Thu,  8 Sep 2022 15:22:00 -0700 (PDT)
Received: from mg.ssi.bg (localhost [127.0.0.1])
        by mg.ssi.bg (Proxmox) with ESMTP id 4D4A52BE19;
        Fri,  9 Sep 2022 01:22:00 +0300 (EEST)
Received: from ink.ssi.bg (unknown [193.238.174.40])
        by mg.ssi.bg (Proxmox) with ESMTP id 43F612BE17;
        Fri,  9 Sep 2022 01:21:57 +0300 (EEST)
Received: from ja.ssi.bg (unknown [178.16.129.10])
        by ink.ssi.bg (Postfix) with ESMTPS id A48C43C0505;
        Fri,  9 Sep 2022 01:21:52 +0300 (EEST)
Received: from ja.home.ssi.bg (localhost.localdomain [127.0.0.1])
        by ja.ssi.bg (8.17.1/8.16.1) with ESMTP id 288MLq32147612;
        Fri, 9 Sep 2022 01:21:52 +0300
Received: (from root@localhost)
        by ja.home.ssi.bg (8.17.1/8.17.1/Submit) id 288MLqUP147611;
        Fri, 9 Sep 2022 01:21:52 +0300
...
Subject: [RFC PATCHv2 3/4] ipvs: add est_cpulist and est_nice sysctl vars
Date:   Fri,  9 Sep 2022 01:21:08 +0300
Message-Id: <20220908222109.147452-4-ja@ssi.bg>
...
index cffb63d3020c..4486324afc84 100644
...
@@ -982,6 +986,12 @@ struct netns_ipvs {
...
@@ -1131,6 +1141,19 @@ static inline int sysctl_run_estimation(struct netns_ipvs *ipvs)
...
@@ -1228,6 +1251,16 @@ static inline int sysctl_run_estimation(struct netns_ipvs *ipvs)
 	return 1;
 }
...
+
 ...
 /* IPVS core functions
@@ -1538,6 +1571,23 @@ int ip_vs_est_kthread_start(struct netns_ipvs *ipvs,
...
index eb973a664c26..6024ea8075e4 100644
...
@@ -207,6 +210,7 @@ void ip_vs_est_reload_start(struct netns_ipvs *ipvs)
...
@@ -237,6 +241,9 @@ int ip_vs_est_kthread_start(struct netns_ipvs *ipvs,
 		goto out;
 	}
...
@@ -286,7 +293,7 @@ static int ip_vs_est_add_kthread(struct netns_ipvs *ipvs)
