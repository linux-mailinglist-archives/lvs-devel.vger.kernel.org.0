...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 06ADF2EBD68
	for <lists+lvs-devel@lfdr.de>; Wed,  6 Jan 2021 13:00:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726074AbhAFMAL (ORCPT <rfc822;lists+lvs-devel@lfdr.de>);
        Wed, 6 Jan 2021 07:00:11 -0500
Received: from mg.ssi.bg ([178.16.128.9]:48798 "EHLO mg.ssi.bg"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725906AbhAFMAL (ORCPT <rfc822;lvs-devel@vger.kernel.org>);
        Wed, 6 Jan 2021 07:00:11 -0500
Received: from mg.ssi.bg (localhost [127.0.0.1])
        by mg.ssi.bg (Proxmox) with ESMTP id DE636179AE;
        Wed,  6 Jan 2021 13:59:29 +0200 (EET)
Received: from ink.ssi.bg (ink.ssi.bg [178.16.128.7])
        by mg.ssi.bg (Proxmox) with ESMTP id 02C29179A9;
        Wed,  6 Jan 2021 13:59:27 +0200 (EET)
Received: from ja.ssi.bg (unknown [178.16.129.10])
        by ink.ssi.bg (Postfix) with ESMTPS id 472BC3C09BE;
        Wed,  6 Jan 2021 13:59:26 +0200 (EET)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
        by ja.ssi.bg (8.15.2/8.15.2) with ESMTP id 106BxNgX009865;
        Wed, 6 Jan 2021 13:59:24 +0200
Date:   Wed, 6 Jan 2021 13:59:23 +0200 (EET)
From:   Julian Anastasov <ja@ssi.bg>
To:     dpayne <darby.payne@gmail.com>
cc:     horms@verge.net.au, lvs-devel@vger.kernel.org
Subject: Re: [PATCH v5] ipvs: add weighted random twos choice algorithm
In-Reply-To: <20210105201458.4082596-1-darby.payne@gmail.com>
Message-ID: <c97fced3-b6b7-ba40-274c-7a5749bbe48a@ssi.bg>
References: <de283f1a-7adf-7633-d877-d8601dd4d7@ssi.bg> <20210105201458.4082596-1-darby.payne@gmail.com>
MIME-Version: 1.0
...
On Tue, 5 Jan 2021, dpayne wrote:
...
> +	int rweight1, rweight2, weight1 = -1, weight2 = -1, overhead1 = 0,
	...
	Does not compile due to above comma at end.
