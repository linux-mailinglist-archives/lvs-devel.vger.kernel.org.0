...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C52D95F8C0D
	for <lists+lvs-devel@lfdr.de>; Sun,  9 Oct 2022 17:37:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230151AbiJIPhs (ORCPT <rfc822;lists+lvs-devel@lfdr.de>);
        Sun, 9 Oct 2022 11:37:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43918 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230040AbiJIPhr (ORCPT
        <rfc822;lvs-devel@vger.kernel.org>); Sun, 9 Oct 2022 11:37:47 -0400
Received: from mg.ssi.bg (mg.ssi.bg [193.238.174.37])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 60F4D1C43E
        for <lvs-devel@vger.kernel.org>; Sun,  9 Oct 2022 08:37:46 -0700 (PDT)
Received: from mg.ssi.bg (localhost [127.0.0.1])
        by mg.ssi.bg (Proxmox) with ESMTP id 8357323F5B;
        Sun,  9 Oct 2022 18:37:45 +0300 (EEST)
Received: from ink.ssi.bg (unknown [193.238.174.40])
        by mg.ssi.bg (Proxmox) with ESMTP id AAACE23F59;
        Sun,  9 Oct 2022 18:37:43 +0300 (EEST)
Received: from ja.ssi.bg (unknown [178.16.129.10])
        by ink.ssi.bg (Postfix) with ESMTPS id 6880B3C043A;
        Sun,  9 Oct 2022 18:37:37 +0300 (EEST)
Received: from ja.home.ssi.bg (localhost.localdomain [127.0.0.1])
        by ja.ssi.bg (8.17.1/8.16.1) with ESMTP id 299Fbb94126026;
        Sun, 9 Oct 2022 18:37:37 +0300
Received: (from root@localhost)
        by ja.home.ssi.bg (8.17.1/8.17.1/Submit) id 299FbavE126025;
...
Subject: [RFC PATCHv5 2/6] ipvs: use common functions for stats allocation
Date:   Sun,  9 Oct 2022 18:37:06 +0300
Message-Id: <20221009153710.125919-3-ja@ssi.bg>
...
@@ -4224,7 +4238,7 @@ int __net_init ip_vs_control_net_init(struct netns_ipvs *ipvs)
